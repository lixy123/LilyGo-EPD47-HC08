...
void I2S_Init(i2s_mode_t MODE, int SAMPLE_RATE, i2s_bits_per_sample_t BPS) {
  ...
  pin_config.bck_io_num   = TWATCH_DAC_IIS_BCK;
  pin_config.ws_io_num    = MIC_CLOCK;    
  //pin_config.data_out_num = I2S_PIN_NO_CHANGE;  //LILYGO_WATCH_2020_V3 此句换成下句，否则无法录音
  pin_config.data_out_num = TWATCH_DAC_IIS_DOUT;  
