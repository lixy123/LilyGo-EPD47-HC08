...
1.lilygo-epd47 电池供电, HC08蓝牙设备, 随时接收文字信息并显示的屏<br/>
     ...
     lilygo 公司已开始出货 hc-08在lilygo-epd47 墨水屏上的专用集成模块成品,触摸屏供电处接长供电,引脚,集成度更好. <br/>
     <br/>
...
https://github.com/ivanseidel/LinkedList 最新版本 <br/>
  ...
  <b> 3.epd47_blue_waker_center_weather (蓝牙主机-中心)</b>  <br/>
   <img src= 'https://github.com/lixy123/LilyGo-EPD47-HC08/blob/main/esp32_center.jpg?raw=true' /> <br/>
     ...
     <br/>
     计划实现: <br/>
     1. https://app.simplenote.com/ 云同步笔记本软件 对接 到墨水屏 <br/>
     A.通过网页方式设置约定的某标签的内容, 格式:标题文字内容, 第二行设置时间区间 <br/>
     B. esp32定时http获取约定的标签URL,解析出文字内容+时间区间, 根据时间区间来决定是否该显示内容,刷新数据到墨水屏,一般固定n小时获取一次URL. <br/>
     esp32访问标签例子: https://app.simplenote.com/p/BnKRpS<br/>
      <br/>
